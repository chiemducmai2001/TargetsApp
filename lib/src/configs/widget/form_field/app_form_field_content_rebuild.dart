...
class AppFormFieldContent extends StatefulWidget {
  const AppFormFieldContent({
    super.key,
    this.hintText,
    this.labelText,
    this.validator,
  ...
  @override
  State<AppFormFieldContent> createState() => _AppFormFieldState();
}

class _AppFormFieldState extends State<AppFormFieldContent> {
